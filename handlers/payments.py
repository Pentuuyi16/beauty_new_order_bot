    ...
    try:
        ...
        if payment['status'] == "succeeded":
            ...
            await callback.message.edit_text(
                ...
                "Теперь вам доступно размещение объявлений.\n\n"
                "📌 Обратите внимание:\n"
                "🔹 Объявление создаётся только через бота\n"
                "🔹 Писать текст вручную в чате не нужно и нельзя\n"
                "🔹 После заполнения формы бот сам опубликует заявку в чате",
